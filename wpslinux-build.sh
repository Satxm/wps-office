...
unzip -h > /dev/null || apt install unzip jq
...
# wget -q --referer="https://365.wps.cn" -O wps-365.deb $amd64_url
curl -sS -R -e "https://365.wps.cn" -o wps-365.deb $amd64_url
# wget -q https://ghproxy.net/https://github.com/Satxm/wps-office/releases/download/wps-fonts/wps-fonts.zip
curl -sS -R -O https://ghproxy.net/https://github.com/Satxm/wps-office/releases/download/wps-fonts/wps-fonts.zip
# wget -q https://ghproxy.net/https://github.com/Satxm/wps-office/releases/download/wps-license/wps-license.zip
...
date -s "$(stat -c %y wps-365.deb | awk -F. '{print $1}')" > /dev/null
mkdir wps-365
...
rm -rf wps-365/opt/*xiezuo* \
 ...
 wps-365/opt/kingsoft/wps-office/templates/* \
 wps-365/etc/xdg/menus/applications-merged/wps-office.menu \
 wps-365/usr/share/desktop-directories
# fix template path
sed -i 's|URL=.*|URL=/opt/kingsoft/wps-office/office6/mui/zh_CN/templates/newfile.docx|' \
 wps-365/usr/share/templates/wps-office-wps-template.desktop
sed -i 's|URL=.*|URL=/opt/kingsoft/wps-office/office6/mui/zh_CN/templates/newfile.xlsx|' \
